...
OUT = Path("/opt/praxis/solution/features/phase17_confirm_features.csv")
...
def main():
    ...
    rows = [r for r in rows if r["session_id"].startswith("RQ7_CONFIRM_")]

    if not rows:
        raise SystemExit("No RQ7_CONFIRM rows found.")
